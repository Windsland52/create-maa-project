...
感谢你帮助改进 {{displayName}}。请让每次改动保持聚焦，清楚说明对用户可见行为的影响，并提供足够的验证信息，方便维护者 review。

Thanks for helping improve {{displayName}}. Keep each change focused, describe the user-visible impact clearly, and include enough validation for maintainers to review it.
